...
import { ArrowRight, Code, Gauge, FlaskConical, Rocket, Search, LayoutTemplate, HeartHandshake, Server, Brain } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-2xl border-2 flex items-center justify-center transition-all duration-300 cursor-pointer
          ${isActive
      ...
      >
        <step.Icon className={`w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 transition-colors duration-300 ${isActive ? 'text-white' : 'text-primary dark:text-primary-light'}`} />
      </button>

      <div className="flex flex-col items-center gap-0.5">
        <span className={`text-xs sm:text-sm md:text-base font-bold whitespace-nowrap transition-colors ${isActive ? 'text-primary dark:text-primary-light' : 'text-gray-800 dark:text-gray-200'}`}>
...
function Pipeline() {
  ...
  return (
    <div ref={sectionRef} className="max-w-5xl mx-auto">
      ...
      {[0, 1].map((rowIndex) => (
        <div key={rowIndex}>
          <div className="flex items-start justify-center gap-0 min-w-0">
                ...
                <div key={step.key} className="flex items-center min-w-0 shrink">
                  ...
                  {i < 2 && (
                    <motion.div
                      ...
                      className="origin-left mx-2 sm:mx-6 md:mx-12 mb-8 shrink-0"
                    >
                      <div className="flex items-center gap-0.5">
                        <div className="w-4 sm:w-10 md:w-20 h-0.5 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-500 dark:to-gray-700 rounded-full" />
                        <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 dark:text-gray-500 -ml-1" />
                      </div>
                    </motion.div>
                  )}
                </div>
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="order-2 md:order-1">
            ...
            >
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Link
                  to="/contact"
                  className="group inline-flex items-center justify-center gap-2 px-7 py-3 bg-primary text-white rounded-xl font-medium hover:bg-primary-dark transition-colors shadow-md hover:shadow-lg hover:shadow-primary/25"
                >
                  {t('hero.cta.contact')}
              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Link
                  to="/services"
                  className="inline-flex items-center justify-center px-7 py-3 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl font-medium hover:border-primary hover:text-primary dark:hover:border-primary-light dark:hover:text-primary-light transition-colors"
                >
                  {t('hero.cta.services')}
                </Link>
              </motion.div>
          ...
          <div className="order-1 md:order-2 flex justify-center relative">
            <AnimatedPhoto
              src="/image_42.png"
              alt="Ny Fitia"
              ctaLabel={t('hero.photoCta.profile')}
              ctaTo="/profil"
            />
            {/* Floating badge */}
            <motion.div
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-3 gap-4 md:gap-8">
